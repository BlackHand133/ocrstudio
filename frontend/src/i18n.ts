...
const en: Dict = {
  ...
  'exp.done': 'Done',
  'exp.noParams': 'no parameters',
  'exp.resetParams': 'Reset values',
  'exp.previewSelected': 'Selected',
  'exp.previewAll': 'All effects',
  'exp.clickZoom': 'click an image to enlarge',
...
const th: Dict = {
  ...
  'exp.done': 'เสร็จสิ้น',
  'exp.noParams': 'ไม่มีพารามิเตอร์',
  'exp.resetParams': 'รีเซ็ตค่า',
  'exp.previewSelected': 'เฉพาะที่เลือก',
  'exp.previewAll': 'ทุกเอฟเฟกต์',
  'exp.clickZoom': 'คลิกที่รูปเพื่อดูเต็มจอ',
