...
Uses PaddlePaddle model to detect whether text is upside down (180°).

Model: PP-LCNet_x1_0_textline_ori
Input: 80x160 (H x W)
Output: 0_degree or 180_degree
"""
...
from modules.constants import MODEL_TEXTLINE_ORIENTATION_PATH
